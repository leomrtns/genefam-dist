...
main (int argc, char **argv)
{
  ...
  gt1 = read_topology_space_from_file_with_burnin_thin (argv[1], NULL, burnin, thin);
  time1 = clock (); fprintf (stderr, "read timing 1: %.8f secs\n", (double)(time1-time0)/(double)CLOCKS_PER_SEC);
  time0 = time1;

  gt2 = read_topology_space_from_file_with_burnin_thin (argv[2], gt1->taxlabel_hash, burnin, thin);
